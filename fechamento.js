                        ...
                        try {
                            ...
                            if (workItemResponse.ok) {
                                ...
                                if (fields['System.WorkItemType'] === 'User Story') {
                                    ...
                                    html += '<tr data-user="' + assignee.replace(/"/g, '&quot;') + '"><td><a href="#" class="workitem-id" onclick="abrirFechamento(' + workItemData.id + ')">' + workItemData.id + '</a></td><td>' + (fields['System.WorkItemType'] || 'N/A') + '</td><td>' + (fields['System.Title'] || 'N/A') + '</td><td>' + (fields['System.State'] || 'N/A') + '</td><td>' + assignee + '</td><td><a href="' + workItemData._links.html.href + '" target="_blank" class="workitem-link">Ver no Azure</a></td><td><button class="btn-analise-ia" onclick="analisarWorkItem(' + workItemData.id + ')">Verificar</button></td>' + requestCell + '</tr>';
                                }
                            }
                        } catch (error) {
